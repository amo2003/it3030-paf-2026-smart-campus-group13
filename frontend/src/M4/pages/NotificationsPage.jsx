...
const TYPE_META = {
  ...
  TICKET_CREATED:    { icon: "🎫", color: "#7c3aed", bg: "#faf5ff", border: "#ddd6fe", label: "Ticket"     },
  TICKET_RESOLVED:   { icon: "✅", color: "#059669", bg: "#f0fdf4", border: "#bbf7d0", label: "Resolved"   },
  TICKET_REJECTED:   { icon: "❌", color: "#dc2626", bg: "#fef2f2", border: "#fecaca", label: "Rejected"   },
